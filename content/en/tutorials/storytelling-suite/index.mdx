...
summary: 'Storytelling Suite (STS): Crafting In/Tangible Stories'
---
...
<Video provider="youtube" id="VafQAFCqduw">
...
![](/assets/content/en/tutorials/storytelling-suite/aaa.png)
...
<Video provider="youtube" id="VafQAFCqduw" startTime={11}>
...
<Video provider="youtube" id="VafQAFCqduw" startTime={48}>
...
<Video provider="youtube" id="VafQAFCqduw" startTime={87}>
...
<Video provider="youtube" id="VafQAFCqduw" startTime={134}>
...
<Video provider="youtube" id="VafQAFCqduw" startTime={185}>
...
<Video provider="youtube" id="VafQAFCqduw" startTime={231}>
...
<Video provider="youtube" id="VafQAFCqduw" startTime={271}>
...
<Video provider="youtube" id="VafQAFCqduw" startTime={300}>
...
<Video provider="youtube" id="VafQAFCqduw" startTime={323}>
...
<Video provider="youtube" id="VafQAFCqduw" startTime={378}>
...
<Video provider="youtube" id="VafQAFCqduw" startTime={413}>
...
<Video provider="youtube" id="VafQAFCqduw" startTime={444}>
...
<Video provider="youtube" id="VafQAFCqduw" startTime={461}>
...
<Video provider="youtube" id="VafQAFCqduw" startTime={496}>
...
<Video provider="youtube" id="VafQAFCqduw" startTime={552}>
...
<Video provider="youtube" id="VafQAFCqduw" startTime={571}>
...
<Video provider="youtube" id="VafQAFCqduw" startTime={584}>
...
<Video provider="youtube" id="VafQAFCqduw" startTime={606}>
